...
fn add_float(p0: f64, p1: f64) -> f64 {
    p0 + p1
}

fn subtract_float(p0: f64, p1: f64) -> f64 {
    p0 - p1
}

fn multiply_float(p0: f64, p1: f64) -> f64 {
    p0 * p1
}

fn divide_float(p0: f64, p1: f64) -> f64 {
    p0 / p1
}

fn modulo_float(p0: f64, p1: f64) -> f64 {
    p0 % p1
}

fn power_float(p0: f64, p1: f64) -> f64 {
    p0.powf(p1)
}
